...
export const LINKEDIN_POSTS: LinkedInPost[] = [
  ...
  },
  {
    ...
    category: "Initiative",
    description: "Supporting a digital-empowerment initiative — AI put to practical use.",
  ...
  },
  {
    ...
    category: "Leadership",
    description: "Leadership is shifting from managing down to coaching. A note on how I run teams.",
    link: "https://www.linkedin.com/posts/rohitmallavarapu17_aimarketing-marketinginnovation-digitaltransformation-activity-7318241480840486914-mMLC",
